...
public class UserData extends LoginPasswordControll {
	...
	public boolean CheckUserData(String userName, char[] userPassword) throws URISyntaxException, IOException {
		...
		if (file.exists() == false) {
			...
			try {
				passwordCheck = verifyUserPassword(userPassword, savedUserPasswordChar, savedSalt);
				if (passwordCheck) {
